...
const PLANOS = {
  ...
  /**
   * Oferta que aparece no pop-up de quem clicou no Básico: o Premium com
   * desconto. É um plano de verdade, com id próprio, porque o preço tem que
 ...
 *
 * Tem que ser uma lista SEPARADA: o completo já traz os cinco materiais de
 * cima, e oferecer qualquer um deles de novo seria cobrar duas vezes pelo
 * mesmo PDF. Aqui entram só produtos que NÃO estão dentro do completo.
 *
 * `icone` é opcional: sem ele o checkout mostra o bump só com título e
 * descrição. Quando a arte existir, é só colocar o arquivo em public/img/ e
 * apontar aqui — nada mais muda.
 */
...
const ORDER_BUMPS = {
  ...
  /* Os três abaixo são produtos de fora do kit completo — por isso só eles
     podem aparecer para quem aceita a oferta do pop-up. Ainda sem arte. */

  'passa-ou-repassa': {
    titulo: 'Passa ou Repassa Bíblico',
    descricao: 'O quiz em duplas que já é sucesso nas turmas: pergunta, passa ou repassa.',
    amount: 690,
    icone: null,
    planos: PLANOS_COM_BUMP_OFERTA
  },
  'desenhos-colorir': {
    titulo: '30 Desenhos para Colorir',
    descricao: 'Trinta páginas bíblicas prontas para imprimir e colorir.',
    amount: 690,
    icone: null,
    planos: PLANOS_COM_BUMP_OFERTA
  },
  'quiz-biblico': {
    titulo: '30 Quiz para Testar o Conhecimento Bíblico',
    descricao: 'Trinta rodadas de perguntas para fechar a aula testando quem prestou atenção.',
    amount: 790,
    icone: null,
    planos: PLANOS_COM_BUMP_OFERTA
  }
